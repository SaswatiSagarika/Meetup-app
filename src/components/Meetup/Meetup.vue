        ...
        <v-card>
          <v-card-title>
            ...
            <template v-if="userIsCreator">
              <v-spacer></v-spacer>
              <app-edit-meetup-details-dailog :meetup="meetup"></app-edit-meetup-details-dailog>
            </template>
          </v-card-title>
          <v-card-media
            :src="meetup.imageUrl"
          ...
          <v-card-actions>
            ...
            <v-spacer></v-spacer>
            <v-btn fab accent color="primary" dark @click="openUrl">
...
<script>
  export default {
    ...
    methods: {
      openUrl () {
        console.log(this.meetup.imageUrl)
        window.open(this.meetup.imageUrl, "_blank");
      }
    }
  }
</script>
